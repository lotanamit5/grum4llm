#!/usr/bin/env python3
"""Quick personalized-choice synthetic experiment runner.
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.mode in ("asymptotic", "both"):
        ...
        # Personalized does not yet accept dataset or n_jobs in signature, so we just pass what it needs
        points = run_personalized_asymptotic(
            agent_counts=counts,
            repeats=args.repeats,
            seed=args.seed,
            dataset=args.dataset,
